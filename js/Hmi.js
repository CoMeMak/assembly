define((require, exports, module) => {
  ...
  class Hmi {
    constructor() {
      ...
      /*geo.V0.x = 0; geo.V0.y = 1.5;  geo.V0.z = 2; 
    geo.V1.x = 0; geo.V1.y = 0;  geo.V1.z = 6; 
    geo.V2.x = 0; geo.V2.y = -1.5;  geo.V2.z = 0; 
    geo.V3.x = 4.5; geo.V3.y = 0;  geo.V3.z = 0; 
    geo.V4.x = 1.5; geo.V4.y = 0;  geo.V4.z = 0;
      */
      Robot.dispatch('ROBOT_CHANGE_GEOMETRY', geo);
      
      Target.dispatch('SET_CONTROL_VISIBLE', false);
    ...
    setCoords(coords) {
        Robot.dispatch('ROBOT_CHANGE_TARGET', {
         position: {
        x: coords.x,
        y: coords.y,
        z: coords.z,
    ...
    getCoords() {
        return {pose: {x:Robot.getState().target.position.x, y:Robot.getState().target.position.y, z:Robot.getState().target.position.z,rx:Robot.getState().target.rotation.x,ry:Robot.getState().target.rotation.y,rz:Robot.getState().target.rotation.z}, axes: [Robot.getState().angles.A0,Robot.getState().angles.A1,Robot.getState().angles.A2,Robot.getState().angles.A3,Robot.getState().angles.A4,Robot.getState().angles.A5]};
